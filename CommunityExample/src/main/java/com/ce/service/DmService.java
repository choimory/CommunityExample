...
public interface DmService {
	 ...
	 public int write(MemberDTO memberDto, DmDTO dmDto); //입력된 값으로 row등록
	 public List<DmDTO> search(String mId, DmDTO dmDto, SearchHelper searchHelper, PageHelper pageHelper); //query와 target과 page를 이용해 검색한 결과 뿌리기
