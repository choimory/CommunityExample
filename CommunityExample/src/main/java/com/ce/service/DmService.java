...
public interface DmService {
	 public List<DmDTO> list(MemberDTO memberDto, PageHelper pageHelper, SearchHelper searchHelper); //send컬럼에 해당 id와 page를 이용한 검색한 결과 가져오기
	 public Map<String,Object> content(String stringDmIdx, PageHelper pageHelper); //idx의 컬럼값들 가져와서 뿌리기, receivedate값 확인후 값이 없을시 receivedate수정, idx에 int가 아닌 값 들어올시 생기는 문제 수정할것
