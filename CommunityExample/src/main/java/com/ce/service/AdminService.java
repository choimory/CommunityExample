...
public interface AdminService {
	  public int ban(MemberDTO memberDto, MemberInfoDTO memberInfoDto); //해당 ID의 ENDTOBAN 컬럼 값 변경
	  ...
	  public Map<String, Object> main(); //checkItem 최신글, checkReport 최신글 5개정도 가져오기 
}
