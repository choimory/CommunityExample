...
<div class="container bg-white col-lg-8 p-4">
	...
	<div id="ce_comment_list" class="ce_comment_list">
		<small>
			<table class="table">
				<thead class="thead-dark">
					<tr>
	...
	<div class="ce_comment_form text-center">
		<form action="/communityexample/comment/write" method="post">
			<div class="form-row">
				<c:if test="${memberDto.memberInfoDto.mAdmin ne null }">
	...
	<div class="board_info mt-5 pt-5">
		...
		<div class="ce_board_list_form text-center">
			<form action="/communityexample/${boardTypeDto.bId}/${boardDto.bIdx}">
				<div class="form-row">
