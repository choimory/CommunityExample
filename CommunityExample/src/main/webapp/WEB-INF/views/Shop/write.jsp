...
<div class="container bg-white col-lg-8 p-4">
	...
	<div class="ce_shop_main_title mb-5 pb-5">
		<span class="h3 mr-2"><a href="/communityexample/shop"
			class="text-dark text-decoration-none">상점 업로드<i
				class="fas fa-store-alt mx-1 text-warning"></i></a></span> <span
			class="blockquote-footer">아이콘 혹은 프로필을 업로드할 수 있습니다.</span>
	</div>


	<div class="ce_shop_write_form">
		<form action="/communityexample/shop/write" method="post">
			<div class="row my-2">
				...
				<div class="form-group col-xl-10">
					<input type="text" class="form-control" placeholder="제목" name="sTitle">
				</div>
			</div>
			<div class="form-group my-2">
				<textarea class="form-control" id="exampleFormControlTextarea1"
					rows="10" placeholder="내용" name="sContent"></textarea>
			</div>
			<div class="form-group my-2">
