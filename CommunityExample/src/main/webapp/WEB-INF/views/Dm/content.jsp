		...
		<table class="table">
			...
			<tbody>
				<tr class="font-weight-light">
					<td class="text-left">
						<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Bootstrap_logo.svg/1200px-Bootstrap_logo.svg.png" width="15" height="15" class="mx-1" alt=""><small>${dmDto.dmSenderNickname}</small>
					</td>
					<td class="text-md-right">
						<small> <i class="far fa-calendar-alt mx-1 text-info"></i>발신일 ${dmDto.dmSendDate} <i class="far fa-calendar-alt mx-1 text-danger"></i>수신일 ${dmDto.dmReceiveDate} 
						</small>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="text-right" colspan="2">
						<a href="" class="text-body text-decoration-none"><i class="fas fa-paperclip fa-2x mx-2"></i></a><a href="" class="text-body text-decoration-none"> <i class="fas fa-share-alt fa-2x mx-2"></i></a><a href="" class="text-body text-decoration-none"> <i class="far fa-flag fa-2x mx-2"></i></a>
					</td>
				</tr>
				<tr>
					<td class="text-right" colspan="2">
						<a href="" class="text-body text-decoration-none"><i class="fas fa-reply fa-2x mx-2"></i></a> <a href="" class="text-body text-decoration-none"><i class="far fa-trash-alt fa-2x mx-2"></i></a>
					</td>
				</tr>
			</tbody>
		</table>
